    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            if(savedInstanceState == null) {
                ScienceQuizDbHelper dbHelper = new ScienceQuizDbHelper(this);
    ...
    public void confirmNext(View view){
        if (!answered) {
            if (rb1.isChecked() || rb2.isChecked() || rb3.isChecked()) {
                ...
                Toast.makeText(ScienceQuizActivity.this, "Please Select An Option", Toast.LENGTH_SHORT).show();
            }
        } else {
            showNextQuestion();
        }
...
//        setResult(RESULT_OK, resultIntent);
        ...
        StaticScore.scienceScore = score ;
        score = 0;
