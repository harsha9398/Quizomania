    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            if(savedInstanceState == null) {
                MathematicsQuizDbHelper dbHelper = new MathematicsQuizDbHelper(this);
    ...
    public void confirmNext(View view){
        if (!answered) {
            if (rb1.isChecked() || rb2.isChecked() || rb3.isChecked()) {
                ...
                Toast.makeText(MathematicsQuizActivity.this, "Please Select An Option", Toast.LENGTH_SHORT).show();
            }
        } else {
            showNextQuestion();
        }
