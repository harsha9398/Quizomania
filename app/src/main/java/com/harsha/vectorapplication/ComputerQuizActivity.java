    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            if(savedInstanceState == null) {
                ComputerQuizDbHelper dbHelper = new ComputerQuizDbHelper(this);
...
//                }
    ...
    public void confirmNext(View view){
        if (!answered) {
            if (rb1.isChecked() || rb2.isChecked() || rb3.isChecked()) {
                ...
                Toast.makeText(ComputerQuizActivity.this, "Please Select An Option", Toast.LENGTH_SHORT).show();
            }
        } else {
            showNextQuestion();
        }
    ...
    public void finishQuiz(){
       /* Intent resultIntent = new Intent();
        ...
        StaticScore.computerScore = score ;
        score = 0;
