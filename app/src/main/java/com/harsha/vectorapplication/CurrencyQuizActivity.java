...
public class CurrencyQuizActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_currency_quiz);
        ...
        try {
            ...
            if(savedInstanceState == null) {
                CurrencyQuizDbHelper dbHelper = new CurrencyQuizDbHelper(this);
...
//                }
    ...
    public void confirmNext(View view){
        if (!answered) {
            if (rb1.isChecked() || rb2.isChecked() || rb3.isChecked()) {
                ...
                Toast.makeText(CurrencyQuizActivity.this, "Please Select An Option", Toast.LENGTH_SHORT).show();
            }
        } else {
            showNextQuestion();
        }
    ...
    public void finishQuiz(){
       /* Intent resultIntent = new Intent();
        ...
        StaticScore.currencyScore = score ;
        score = 0;
